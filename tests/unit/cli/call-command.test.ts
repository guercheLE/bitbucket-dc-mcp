...
describe('callCommand', () => {
  ...
  it('should handle dry run mode', async () => {
    ...
    expect(mockConsole.log).toHaveBeenCalledWith(expect.stringContaining('Dry run mode'));
  });
  ...
  it('should handle missing operation gracefully', async () => {
    ...
    const { JsonOperationsRepository } = await import('../../../src/data/operations-repository.js');
